...
public class EMICalculator extends CommonActivity {
    ...
    private String TAG = EMICalculator.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setseekBar(emiAmount, emiAmountSeekBar, 0, 20000000, 1.0f);
...
//        mChart.setOnChartValueSelectedListener(this);
        ...
        entries.add(new PieEntry(Float.valueOf(emiAmount.getText().toString().replaceAll("\u20B9", ""))));
        entries.add(new PieEntry(Float.valueOf(emiTotalInterest.getText().toString().replaceAll("\u20B9", ""))));
